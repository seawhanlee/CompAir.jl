"""
    intake_ramp(M_infty::Real, ramp_angle::Vector{<:Real}, gamma=1.4)

주어진 램프 각도(ramp_angle) 배열과 자유류 마하수(M_infty), 비열비(gamma)에 대해 다단 램프 흡입구의 각 단에서의 마하수, 밀도비, 압력비, 전체압비, 충격파 각도를 계산합니다.
