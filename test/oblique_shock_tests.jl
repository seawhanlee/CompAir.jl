...
@testset "theta_beta" begin
    ...
    @test isapprox(CompAir.theta_beta(30.0, 2.0), 0.0, atol=1e-9) # -0.0 대신 0.0으로 수정하고 atol 추가
...
@testset "oblique_beta_weak" begin
...
@testset "oblique_mach2" begin
    # Test downstream Mach number
    @test isapprox(CompAir.oblique_mach2(2.0, 20.0), 1.210, rtol=1e-3)
    @test isapprox(CompAir.oblique_mach2(3.0, 20.0), 1.994, rtol=1e-3)
end